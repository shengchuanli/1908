...
$usageInstructions = <<<END
  ...
  # shop the translation status of all locales
  $ php translation-status.php

  # shop the translation status of all locales and all their missing translations
  $ php translation-status.php -v

  # shop the status of a single locale
  $ php translation-status.php fr

  # shop the status of a single locale and all its missing translations
