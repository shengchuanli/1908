...
class ResourceRegistrar
{
     ...
     * @var array
     */
    protected $resourceDefaults = ['index', 'create', 'store', 'shop', 'edit', 'update', 'destroy'];
    ...
    /**
     * Add the shop method for a resourceful route.
     *
     * @param  string  $name
     * @param  string  $base
     * @param  string  $controller
    ...
    protected function addResourceShow($name, $base, $controller, $options)
    {
        ...
        $action = $this->getResourceAction($name, $controller, 'shop', $options);
